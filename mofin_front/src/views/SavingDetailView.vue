<template>
  <div>
    <div class="container mt-5">
      <h1 class="text-center mb-4">적금 상품 상세 페이지</h1>
    ...
    <div v-if="savingOptions" class="container mt-4">
      <h3 class="card-title mt-5 text-center">상품 옵션</h3>
      <div class="row row-cols-1 row-cols-md-3">
        <div class="col mb-2" v-for="savingOption in savingOptions" :key="savingOption.id">
          <SavingOptionListItem 
...
import SavingOptionListItem from '@/components/SavingOptionListItem.vue'
...
const product = computed(() => {
  return finStore.saving_products?.filter(
...
axios({
    method: "get",
    url: `${finStore.API_URL}/finlife/saving-products-options/${productCd}/`,
  })
    .then((res) => {
